...
export default function About() {
    return (
        <div>
            <div className="about-company-h1">
              <h1>TOSSPI is The Place To Shop!</h1>
            </div>
    
            <div className="about-company-info">
                <p>
                    It is time to declutter and make a little extra money from it.  TOSSPI is the place to sell these items at.

                    Our goal here at TOSSPI is to help all of us declutter our homes, closets, basements, garages, storage units, etc. We give you a place to sell these items by connecting you with millions and millions of potential customers world wide.

                    Why not decide to sell these various items and put a little cash back into our bank accounts or wallets.  Let someone else enjoy these items that you have stashed away and no longer use.  
